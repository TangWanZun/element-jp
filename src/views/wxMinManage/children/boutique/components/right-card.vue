	...
	<div style="height:100%;">
      ...
      <card-table style="height:100%;">
        ...
        >
          ...
          <el-table-column prop="itemCode" label="集采产品编码" width="150" show-overflow-tooltip	></el-table-column>
          <el-table-column prop="itemName" label="精品名称" show-overflow-tooltip	></el-table-column>
      ...
      setTimeout(() => {
        ...
        for(let i=0;i<20;i++){
          this.tableData.push({
            ...
            itemName:'丹麦.丹拿旗舰版奔驰专用音响套装（SurpaxM17F+SurpaxM17B+SurpaxM17S）',
